...
if {[file isfile dfr_inference.autotvin.dat]} {
	file delete -force dfr_inference.autotvin.dat
}

if {[file isfile dfr_inference.autotvout.dat]} {
	file delete -force dfr_inference.autotvout.dat
}
