...
//------------------------Parameter----------------------
`define TV_IN_inputs "../tv/cdatafile/c.dfr_inference.autotvin_inputs.dat"
`define TV_OUT_inputs "../tv/rtldatafile/rtl.dfr_inference.autotvout_inputs.dat"
 parameter inputs_ADDR_BITWIDTH = 32'd 64;
 parameter inputs_AWUSER_BITWIDTH = 32'd 1;
 parameter inputs_DATA_BITWIDTH = 32'd 32;
 parameter inputs_WUSER_BITWIDTH = 32'd 1;
 parameter inputs_ID_BITWIDTH = 32'd 1;
 parameter inputs_RUSER_BITWIDTH = 32'd 1;
 parameter inputs_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   1 + 1;
 parameter   mem_page_num            =   32'd 3;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter inputs_C_DATA_BITWIDTH = 32'd 32;
parameter inputs_mem_depth = 32'd 510200;
parameter ReadReqLatency = 32'd 1;
parameter WriteReqLatency = 32'd 1;
// Input and Output
input clk;
input reset;
input  TRAN_inputs_AWVALID;
output  TRAN_inputs_AWREADY;
input [inputs_ADDR_BITWIDTH - 1 : 0] TRAN_inputs_AWADDR;
input [inputs_ID_BITWIDTH - 1 : 0] TRAN_inputs_AWID;
input [8 - 1 : 0] TRAN_inputs_AWLEN;
input [3 - 1 : 0] TRAN_inputs_AWSIZE;
input [2 - 1 : 0] TRAN_inputs_AWBURST;
input [2 - 1 : 0] TRAN_inputs_AWLOCK;
input [4 - 1 : 0] TRAN_inputs_AWCACHE;
input [3 - 1 : 0] TRAN_inputs_AWPROT;
input [4 - 1 : 0] TRAN_inputs_AWQOS;
input [4 - 1 : 0] TRAN_inputs_AWREGION;
input [inputs_AWUSER_BITWIDTH - 1 : 0] TRAN_inputs_AWUSER;
input  TRAN_inputs_WVALID;
output  TRAN_inputs_WREADY;
input [inputs_DATA_BITWIDTH - 1 : 0] TRAN_inputs_WDATA;
input [inputs_DATA_BITWIDTH/8 - 1 : 0] TRAN_inputs_WSTRB;
input  TRAN_inputs_WLAST;
input  TRAN_inputs_WID;
input [inputs_WUSER_BITWIDTH - 1 : 0] TRAN_inputs_WUSER;
input  TRAN_inputs_ARVALID;
output  TRAN_inputs_ARREADY;
input [inputs_ADDR_BITWIDTH - 1 : 0] TRAN_inputs_ARADDR;
input [inputs_ID_BITWIDTH - 1 : 0] TRAN_inputs_ARID;
input [8 - 1 : 0] TRAN_inputs_ARLEN;
input [3 - 1 : 0] TRAN_inputs_ARSIZE;
input [2 - 1 : 0] TRAN_inputs_ARBURST;
input [2 - 1 : 0] TRAN_inputs_ARLOCK;
input [4 - 1 : 0] TRAN_inputs_ARCACHE;
input [3 - 1 : 0] TRAN_inputs_ARPROT;
input [4 - 1 : 0] TRAN_inputs_ARQOS;
input [4 - 1 : 0] TRAN_inputs_ARREGION;
input  TRAN_inputs_ARUSER;
output  TRAN_inputs_RVALID;
input  TRAN_inputs_RREADY;
output [inputs_DATA_BITWIDTH - 1 : 0] TRAN_inputs_RDATA;
output  TRAN_inputs_RLAST;
output [inputs_ID_BITWIDTH - 1 : 0] TRAN_inputs_RID;
output [inputs_RUSER_BITWIDTH - 1 : 0] TRAN_inputs_RUSER;
output [2 - 1 : 0] TRAN_inputs_RRESP;
output  TRAN_inputs_BVALID;
input  TRAN_inputs_BREADY;
output [2 - 1 : 0] TRAN_inputs_BRESP;
output [inputs_ID_BITWIDTH - 1 : 0] TRAN_inputs_BID;
output [inputs_BUSER_BITWIDTH - 1 : 0] TRAN_inputs_BUSER;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [inputs_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [inputs_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [inputs_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [inputs_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [inputs_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [inputs_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg [inputs_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [inputs_DATA_BITWIDTH - 1 : 0] inputs_mem_0 [0: inputs_mem_depth - 1]; 
reg [inputs_DATA_BITWIDTH - 1 : 0] inputs_mem_1 [0: inputs_mem_depth - 1]; 
reg [inputs_DATA_BITWIDTH - 1 : 0] inputs_mem_2 [0: inputs_mem_depth - 1]; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [inputs_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [inputs_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [inputs_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_inputs_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_inputs_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_inputs_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_inputs_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_inputs_BRESP = BRESP_tmp;
assign TRAN_inputs_RDATA = RDATA_tmp;
assign TRAN_inputs_RRESP = RRESP_tmp;
assign TRAN_inputs_RLAST = RLAST_tmp;
assign TRAN_inputs_RVALID = RVALID_tmp;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = inputs_C_DATA_BITWIDTH;
  count_c_data_byte_num_by_bitwidth (c_bitwidth , DATA_byte_num);
end

initial begin : initialize_inputs_mem
  integer i;
  for (i = 0; i < inputs_mem_depth; i = i + 1) begin
      inputs_mem_0[i] = 0;
      inputs_mem_1[i] = 0;
      inputs_mem_2[i] = 0;
  end
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_inputs_AWREADY & TRAN_inputs_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_inputs_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_inputs_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_inputs_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_inputs_AWBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_inputs_ARREADY & TRAN_inputs_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_inputs_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_inputs_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_inputs_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_inputs_ARBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_inputs_WREADY & TRAN_inputs_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_inputs_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_inputs_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_inputs_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_inputs_AWVALID && TRAN_inputs_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_inputs_ARVALID && TRAN_inputs_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_inputs_WVALID && TRAN_inputs_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_inputs_WVALID && TRAN_inputs_WREADY && TRAN_inputs_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_inputs_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_inputs_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [inputs_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [inputs_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [inputs_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > inputs_mem_depth) begin
                $display ("/home/oshears/Documents/vt/research/code/verilog/hybrid_dfr_system/vitis_hls/dfr_core/proj_dfr_core/dfr_core_solution/sim/verilog/AESL_axi_master_inputs.v: Write request address %d exceed AXI master inputs array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, inputs_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = inputs_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = inputs_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = inputs_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : inputs_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : inputs_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : inputs_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = inputs_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = inputs_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = inputs_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : inputs_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : inputs_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : inputs_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > inputs_mem_depth) begin
                $display ("/home/oshears/Documents/vt/research/code/verilog/hybrid_dfr_system/vitis_hls/dfr_core/proj_dfr_core/dfr_core_solution/sim/verilog/AESL_axi_master_inputs.v: Read request address %d exceed AXI master inputs array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, inputs_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= inputs_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= inputs_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= inputs_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_inputs_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= inputs_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= inputs_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= inputs_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  integer mem_page; 
  integer inputs_bitwidth; 
  reg [127 : 0] token; 
  reg [127 : 0] token_tmp; 
  //reg [inputs_C_DATA_BITWIDTH - 1 : 0] token_tmp; 
  reg [inputs_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  inputs_bitwidth = inputs_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (inputs_bitwidth , factor);
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      mem_tmp [inputs_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < inputs_mem_depth; i = i + 1) begin 
          token = read_token(fp);
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  case(mem_page)
                      0 : inputs_mem_0[i/factor] = mem_tmp;
                      1 : inputs_mem_1[i/factor] = mem_tmp;
                      2 : inputs_mem_2[i/factor] = mem_tmp;
          ...
          if (factor == 1) begin
              mem_tmp = token_tmp;
              case(mem_page)
                  0 : inputs_mem_0[i] = mem_tmp;
                  1 : inputs_mem_1[i] = mem_tmp;
                  2 : inputs_mem_2[i] = mem_tmp;
                  default: $display("The page_num of read file is not valid!");
              endcase
              mem_tmp [inputs_DATA_BITWIDTH - 1: 0] = 0;
          end
