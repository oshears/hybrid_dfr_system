...
`define AUTOTB_TVIN_inputs  "./c.dfr_inference.autotvin_inputs.dat"
`define AUTOTB_TVIN_weights  "./c.dfr_inference.autotvin_weights.dat"
`define AUTOTB_TVIN_inputs_out_wrapc  "./rtl.dfr_inference.autotvin_inputs.dat"
`define AUTOTB_TVIN_weights_out_wrapc  "./rtl.dfr_inference.autotvin_weights.dat"
`define AUTOTB_TVOUT_outputs  "./c.dfr_inference.autotvout_outputs.dat"
`define AUTOTB_TVOUT_outputs_out_wrapc  "./impl_rtl.dfr_inference.autotvout_outputs.dat"
module `AUTOTB_TOP;
