...
mg_inputs = np.linspace(0,2,100)
mg_outputs = mackey_glass(mg_inputs)
mg_deriv_outputs = mackey_glass_deriv(mg_inputs)

plt.subplot(2,1,1)
plt.plot(mg_inputs,mg_outputs)
plt.subplot(2,1,2)
plt.plot(mg_inputs,mg_deriv_outputs)
plt.show()
