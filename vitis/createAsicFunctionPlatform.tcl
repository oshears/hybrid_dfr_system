# xsct createAsicFunctionPlatform.tcl
...
exec rm -rf .metadata
exec rm -rf .Xil
exec rm -rf asic_function_system_test_app 
exec rm -rf asic_function_system_test_app_system
exec rm -rf asic_function_system_platform
...
platform create -name {asic_function_system_platform}\
-hw {../vivado/asic_function_system_project/asic_function_system_wrapper.xsa}\
-proc {ps7_cortexa9_0} -os {standalone} -fsbl-target {psu_cortexa53_0} -out {.}

platform write
platform generate -domains 
platform active {asic_function_system_platform}
platform generate
...
dow ./asic_function_system_test_app/Debug/asic_function_system_test_app.elf
